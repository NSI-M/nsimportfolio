<template>
    ...
    <div class="pflexbox">
        <h2>
            <span style="font-family: 'Orbitron';">ATHLETES' Tickets</span>
        </h2>
        <p>
            OPEN12:00/START13:00/PARTY18:00~20:00<br>ご観覧を検討いただきありがとうございます。<br>ご参加の際はご購入ページ記載の利用規約の確認をお願いいたします。外部団体の撮影に関する同意が必要です。
        </p>
        <div class="newsitem">
            <a href="checkout_vip" style="display: flex;">
                ...
                <div class="newsinfo" style="justify-content: center;">
                    <h3>ご招待チケット<br>タップしてチケット情報をご入力ください<br>￥-</h3>
                </div>
            </a>
        </div>
        <div class="newsitem">
            <a href="checkout_vipafter" style="display: flex;">
                <div class="newsimg">
                    <img src="@/assets/img/thumbdef.png"/>
                </div>
                <div class="newsinfo" style="justify-content: center;">
                    <h3>アフターパーティつきご招待チケット<br><del>￥15,000</del>￥5,000</h3>
                </div>
            </a>
        </div>
