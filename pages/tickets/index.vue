<template>
    ...
    <div class="pflexbox">
        <h2>
            <span style="font-family: 'Orbitron';">Tickets</span>
        </h2>
        <p>
            OPEN12:00/START13:00/PARTY18:00~20:30<br>ご参加の際はご購入ページ記載の利用規約の確認をお願いいたします。外部団体の撮影に関する同意が必要です。<br>アフターパーティつきご観覧チケットでは、ショー終了後、次世代の基幹事業と目される「クリエイティブ・エコノミー」の興隆を期し、出展ブランドとクリエイターによるアフターパーティにご参加いただけます。
        </p>
        <div class="newsitem">
