...
<div class="iframecontainer">
    <iframe src="https://www.youtube.com/embed/3D7yMxY3bs8?autoplay=1&controls=0&disablekb=1&loop=1&mute=0&" title="YouTube video player" frameborder="0"allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="flexbox">
            <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:600px;overflow:hidden;visibility:hidden;">
                ...
                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:900px;overflow:hidden;">
                    ...
                    <div>
                        <a href="https://www.kiel-mj.com/" target="_blank">
                            <img src="/img/thumbdef.png" alt="Kiel Management Japan">
                        </a>
                    </div>
                    <div>
                        <a href="https://sakae-clinic.com/" target="_blank">
                            <img src="/img/thumbdef.png" alt="Kiel Management Japan">
                        </a>
                    </div>
                    <div>
                        <a href="https://fem-tech.site/" target="_blank">
                            <img src="/img/thumbdef.png" alt="フェムテックアカデミー">
                        </a>
                    </div>
                    <div>
                        <a href="https://www.kiel-mj.com/" target="_blank">
        ...
        <!-- Shameless Opinion Section -->
        <section id="">
            <div class="title-section">
                <a class="" href="https://shamelessopinion.com" target="_blank">
                    <p class="brandtitle">
                        Shameless Opinion
                    </p>
                </a>
            ...
            <div class="flexbox-2">
                <div class="box">
                    <div class="t-img">
                        <img class="mainimg" alt="shameless opinion" src="/img/26aw1.jpg" data-index="1"/>
                        <div class="t-info">ß
                        </div>
                    </div>
                    <div class="hidden">
                        <img class="mainimg" alt="shameless opinion" src="/img/thumbdef.png" data-index="2"/>
                    </div>
                </div>
                <div class="box">
                    <div class="t-img">
...
/* Jssor Slider Mobile Responsive */
@media (max-width: 768px) {
    #jssor_1 {
...
/* Shameless Opinion Section Styles */
section {
    margin-top: 30px;
}
...
/* 中に配置されるコンテンツ（テキストや画像など）を絶対位置で配置 */
.box>* {
    position: absolute;
    top: 0;
    left: 0;
