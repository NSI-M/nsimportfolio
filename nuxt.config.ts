  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {name:"description", content:"NSIM "},
        {name:"robots", content:"index, follow, max-image-preview:large"},
        {property:"og:title", content:"NSIM"},
        {property:"og:description", content:"NSIM directs branding, designing, engineering and everyday."},
        {property:"og:url", content:"https://www.nsi-m.xyz/"},
        ...
        {property:"twitter:domain", content:"nsi-m.xyz"},
        {property:"twitter:image", content:"/img/thumbb.png"},
        {property:"twitter:title", content:"NSIM"},
        {property:"fb:app_id", content:"350213290965729"},
      ],
      link: [
        {rel: "icon", type:"image/x-icon", href:"/public/faviconl.ico"},
        ...
        {rel:"canonical", href:"https://www.nsi-m.xyz/"},
