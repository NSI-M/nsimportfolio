...
!function(j, h, n, g, d, k, e) {
    ...
    var b = j.$Jssor$ = new function() {
        var i = this, Ab = /\S+/g, N = 1, jb = 2, mb = 3, lb = 4, pb = 5, O, t = 0, l = 0, u = 0, A = 0, B = 0, E = navigator, ub = E.appName, o = E.userAgent, z = h.documentElement, q = parseFloat;
        function Ib() {
            if (!O) {
                O = {
                ...
                var a;
                if (E.pointerEnabled || (a = E.msPointerEnabled))
                    O.Zd = a ? "msTouchAction" : "touchAction"
            }
            return O
        }
        function w(g) {
        ...
        function R(d, a) {
            ...
            if (a) {
                ...
                if (I()) {
                    if (a.$TranslateX || a.$TranslateY || a.$TranslateZ != e)
        ...
        i.pg = function(d, a) {
            if (a)
                d.style.clip = "rect(" + c.$Round(a.$Top || a.F || 0) + "px " + c.$Round(a.$Right) + "px " + c.$Round(a.$Bottom) + "px " + c.$Round(a.$Left || a.G || 0) + "px)";
            else if (a !== e) {
        ...
        ;
        function Gb(a) {
            var d = this, p = "", r = ["av", "pv", "ds", "dn"], f = [], q, m = 0, k = 0, g = 0;
            function l() {
                K(a, q, (f[g || k & 2 || k] || "") + " " + (f[m] || ""));
        ...
        function s(h, l) {
            ...
            function a(d, a) {
                ...
                if (b) {
                    ...
                    if (a.$OriginalWidth)
                        h = k(c, a.$OriginalWidth, a.$OriginalHeight);
                    i.Ag(d, h.y);
                    i.Bg(d, h.x);
                    o = c.Be();
        ...
        i.Rd = function(n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                for (var i in j) {
                    ...
                    if (h != x)
                        h -= x;
                    var k = t.Y || f.$Linear, m, E = n[i], q = j[i];
                    if (b.mc(q)) {
                        k = t[i] || k;
                        var A = k(h);
                        m = E + q * A
                ...
                if (w) {
                    ...
                    if (r() && l >= 11 && (j.G || j.F) && s != 0 && s != 1)
                        a.$Rotate = a.$Rotate || 1e-8;
                    a.Oe = d
                }
            }
            if (j.$Clip && o.$Move) {
            ...
            if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.F && !a.$Clip.G && a.$Clip.$Right == o.$OriginalWidth && a.$Clip.$Bottom == o.$OriginalHeight)
                a.$Clip = g;
            return a
        }
    }
    ...
    var l = function(A, D, g, L, O, J) {
        A = A || 0;
        var a = this, p, m, n, t, B = 0, H, I, G, C, z = 0, h = 0, l = 0, y, i, e, f, o, x, v = [], w;
        function P(a) {
            e += a;
            f += a;
            i += a;
        ...
        if (b.$IsBrowserSafari() && b.$BrowserVersion() < 7 || !u)
            u = function(a) {
    ...
    var m = {
      ...
      , r = j.$JssorSlideshowFormations$ = new function() {
        ...
        h.$FormationSwirl = function(q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.oc, A = [], z = [], u = 0, c = 0, h = 0, r = x - 1, s = y - 1, t, p, v = 0;
            switch (B) {
            case j:
                c = r;
                h = 0;
        ...
        h.$FormationZigZag = function(p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.oc, t = [], u = 0, c = 0, d = 0, q = w - 1, r = x - 1, y, h, s = 0;
            switch (z) {
            case j:
                c = q;
                d = 0;
    ...
    j.$JssorSlideshowRunner$ = function(m, s, o, u, z, A) {
        ...
        function n(z, i, a, v, n, l) {
            var y = this, t, u = {}, h = {}, m = [], f, e, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0, g = a.re(n, l), o = B(a), C = o.length - 1, s = a.$Duration + a.$Delay * C, w = v + s, j = a.$SlideOut, x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
    ...
    j.$JssorBulletNavigator$ = function(a, E) {
        ...
        p.call(f);
        a = b.$GetElement(a);
        var u, C, B, t, l = 0, e, n, j, y, z, i, h, s, r, D = [], A = [];
        function x(a) {
            a != -1 && A[a].zd(a == l)
        }
        function v(a) {
    ...
    j.$JssorThumbnailNavigator$ = function(f, E) {
        var j = this, x, A, s, a, y = [], B, z, e, l, n, w, v, r, t, h, u;
        p.call(j);
        f = b.$GetElement(f);
        function D(n, f) {
            var h = this, c, m, l;
    ...
    j.$JssorCaptionSlideo$ = function(t, k, B, E) {
        var a = this, u, o = {}, v = k.$Transitions, r = k.$Controls, m = new l(0,0), p = [], h = [], D = E, e = D ? 1e8 : 0;
        l.call(a, 0, 0);
        function q(d, c) {
            var a = {};
        ...
        function y(s, t, h) {
            ...
            if (a && f) {
                f.Ae();
                var i = f, k, j = f.pc(), o = f.yb(), p = c.k(o, a.rg);
                if (a.hb < o) {
                    if (a.hb > j) {
                        i = new l(j,a.hb - j);
                        i.W(f, d)
    ...
    var i = j.$JssorSlider$ = (j.module || {}).exports = function() {
        ...
        function Hc(m, f) {
            var e = this, s, I, w, j, x = [], E, y, P, G, M, B, H, h, v, q;
            l.call(e, -N, N + 1, {});
            function z(a) {
                s && s.Bd();
                O(m, a, 0);
            ...
            function O(a, f, c, h) {
                ...
                b.$Each(i, function(a) {
                    ...
                    if (g == "caption") {
                        ...
                        if (e == "A") {
                            if (b.$AttributeEx(a, "u") == "image")
                                j = b.sg(a, "IMG");
                            else
                                j = b.$FindChild(a, "image", d);
                            if (j) {
                                E = a;
                                b.N(E, kb);
                                y = b.$CloneNode(E, d);
                        ...
                        } else if (e == "IMG" && b.$AttributeEx(a, "u") == "image")
                            j = a;
                        if (j) {
                            j.border = 0;
                            b.N(j, kb)
        ...
        function Gc(z, g, p, q) {
            var c = this, n = 0, v = 0, h, j, f, e, m, t, s, o = C[g];
            l.call(c, 0, 0);
            function w() {
                b.Dc(W);
        ...
        function Ab(l, g, m, p) {
            if (!B && (R || !(J & 12)) || n.$NaviQuitDrag) {
                ...
                if (!(D & 1)) {
                    if (p)
                        a = t(a);
                    else if (D & 2 && (a < 0 && c.m(b - H) < .0001 || a > o - P && c.m(b - K) < .0001))
                        a = a < 0 ? K : H;
                    a = Db(a);
                    if (K - a < .5)
                        a = K;
        ...
        a.jc = function(I, m) {
            ...
            n.$HWA = n.$HWA && b.yg();
            if (n.$Idle != e)
                n.$AutoPlayInterval = n.$Idle;
            if (n.$DisplayPieces != e)
                n.$Cols = n.$DisplayPieces;
            if (n.$ParkingPosition != e)
                n.$Align = n.$ParkingPosition;
            ...
            b.$Each(p, function(a, d) {
                ...
                if (c == "loading")
                    ...
                    if (a.tagName != "STYLE" && a.tagName != "SCRIPT")
                        bc[c || d] = new xc(a,c == "slides",b.dd(["slides", "thumbnavigator"])[c])
                }
            });
            Z = Z || b.$CreateDiv(h);
            sb = b.$CssWidth(z);
            ...
            wb = n.$SlideDuration;
            Mb = new Bc;
            if (n.$HWA && (!b.$IsBrowserFireFox() || vb))
                Ib = function(a, c, d) {
                    b.ic(a, {
                        $TranslateX: c,
                        $TranslateY: d
            ...
            if (o) {
                ...
                n.$ArrowKeyNavigation && b.$AddEvent(h, "keydown", function(a) {
                    if (a.keyCode == 37)
                        Bb(-n.$ArrowKeyNavigation, d);
                    else
                        a.keyCode == 39 && Bb(n.$ArrowKeyNavigation, d)
                });
                var l = n.$StartIndex;
                l = t(l);
                Ab(l, 0)
